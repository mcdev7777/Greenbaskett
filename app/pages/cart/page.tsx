        ...
        {isEmpty ? (
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between items-center mt-8 px-4 md:px-8">
              ...
              <Link href="/pages/checkout" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto bg-green-600 hover:bg-green-700 text-white px-8 py-6 rounded-lg font-semibold">
                  PROCEED TO CHECKOUT
                </Button>
              </Link>
            </div>
